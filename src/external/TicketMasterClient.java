...
public class TicketMasterClient {
	...
	private static final String API_KEY = "2SJ1ckM0OleDMD5MViaCpH4BgV5fJoAW";
...
//			System.out.print("wrong url");
	...
	private String getAddress(JSONObject event) throws JSONException {
		if (!event.isNull("_embedded")) {
			JSONObject enbedded = event.getJSONObject("_embedded");
			if (!enbedded.isNull("venues")) {
				JSONArray venues = enbedded.getJSONArray("venues");
